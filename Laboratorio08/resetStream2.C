...
int main(){
   ...
   file_in.clear(); //Ripristina tutti i flag, tra cui quello di EOF 

   file_in.seekg(0,ios::beg); //Sposta la testina a 0 byte dall'inizio del file, ovvero all'inizio del file
